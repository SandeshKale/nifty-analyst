...
1. VIX > 22 → STAY OUT
1. Major event within 24hrs → STAY OUT
1. LIVE_FUNDS < ATM × 65 → STAY OUT (₹${(K.liveF||0).toFixed(0)} vs ₹${((K.atmCeP||0)*65).toFixed(0)})
1. FII L/S < 0.2 AND PCR < 0.6 → STRONG PE
1. Both institutions selling + ADR < 0.5 → STAY OUT
